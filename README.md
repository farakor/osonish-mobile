...
- **Дата выполнения**: переименовано из "Срок выполнения", теперь выбор даты через календарь (сегодня, завтра, через 3 дня, через неделю)
- **Категории**: показываются в 2 ряда вместо горизонтального скролла, сокращены до 6 основных категорий
- **UI**: улучшен дизайн всех новых полей
