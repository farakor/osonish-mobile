...
const buildingSvg = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const BuildingIcon: React.FC<BuildingIconProps> = ({ size = 16, color = '#6B7280' }) => {
  // Заменяем цвет в SVG на основе пропса
  const coloredSvg = buildingSvg.replace(/stroke="black"/g, `stroke="${color}"`);
